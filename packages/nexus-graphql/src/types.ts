...
export interface GraphqlWrapperOptions {
  /**
   * The default exported object generated by `nexus-graphql-generate`
   *
   * Import it from the output directory generated by `nexus-graphql-generate`
   * @example
   * ```
   * import datamodelInfo from './generated/nexus-graphql'
   *
   * makeGraphqlSchema({
   *   wrapperOptions: {
   *     datamodelInfo
...
export interface GraphqlSchemaConfig extends core.BuilderConfig {
  types?: any
  wrapperOptions: GraphqlWrapperOptions
}
